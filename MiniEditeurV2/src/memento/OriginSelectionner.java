...
public class OriginSelectionner extends command.Selectionner implements OriginatorInter<int[]> {
	 ...
	 */
	public OriginSelectionner(receiver.MoteurEd receiver, CareTaker recorder) {
		super(receiver);
	...
	public Memento<int[]> getMemento() {
		return new ConcretMSelectionner(this.pos);
	}
